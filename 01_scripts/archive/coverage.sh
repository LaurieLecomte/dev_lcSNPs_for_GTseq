...
# parallel -a 02_infos/Bastien_samples.txt -j 10 srun -p small -c 1 -J coverage_{} -o log/coverage_{}_%j.log /bin/sh 01_scripts/coverage.sh {} &

# cat coverage/*.meancov.txt > samples_Bastien_Xavier_meancov.txt 
